//
//  KSActivityWelfareQRCodeViewController.m
//  koushao_iOS
//
...
#import "KSActivityWelfareQRCodeViewController.h"

#import <AVFoundation/AVFoundation.h>
#import "Masonry.h"
#import "KSActivitySignQRCodeViewModel.h"
@interface KSActivityWelfareQRCodeViewController ()<AVCaptureMetadataOutputObjectsDelegate>
...
@implementation KSActivityWelfareQRCodeViewController
...
- (void)viewDidLoad {
    ...
    [[[RACObserve(self, result) takeUntil:self.rac_willDeallocSignal] throttle:1] subscribeNext:^(NSString *x) {
        if (x != nil){
            NSLog(@"扫描结果 = %@" , x);
