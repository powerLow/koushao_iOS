...
#define KSSuccess(message) [TWMessageBarManager.sharedInstance showMessageWithTitle:KS_ALERT_TITLE description:message type:TWMessageBarMessageTypeSuccess statusBarStyle:UIStatusBarStyleLightContent callback:NULL]
#define KSError(message)   [TWMessageBarManager.sharedInstance showMessageWithTitle:KS_ALERT_TITLE description:message type:TWMessageBarMessageTypeError statusBarStyle:UIStatusBarStyleLightContent callback:NULL]
#define KSInfo(message)    [TWMessageBarManager.sharedInstance showMessageWithTitle:KS_ALERT_TITLE description:message type:TWMessageBarMessageTypeInfo statusBarStyle:UIStatusBarStyleLightContent callback:NULL]
