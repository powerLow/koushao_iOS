...
+ (void)initialize
{
	if (self == [TWDefaultMessageBarStyleSheet class])
	{
        ...
        kTWDefaultMessageBarStyleSheetSuccessBackgroundColor = [UIColor colorWithRed:0.172f green:0.741f blue:0.525f alpha:kTWMessageBarStyleSheetMessageBarAlpha]; // green
